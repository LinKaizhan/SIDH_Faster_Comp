...
{ // Alice's ephemeral public key generation using compression -- SIDH protocol
  // Output: PrivateKeyA[MSG_BYTES + SECRETKEY_A_BYTES] <- x(K_A) where K_A = PA + sk_A*Q_A 
    ...
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->X[0][6 - i]);
    //}
    //printf("\n");
    //printf("X[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->X[1][6 - i]);
    //}
    //printf("\n");
    //printf("Y[0]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->Y[0][6 - i]);
    //}
    //printf("\n");
    //printf("Y[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->Y[1][6 - i]);
    //}
    //printf("\n");
    //printf("Z[0]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->Z[0][6 - i]);
    //}
    //printf("\n");
    //printf("Z[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[0]->Z[1][6 - i]);
    //}
    //printf("\n");
    //printf("Rs[1]\n");
    //printf("X[0]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->X[0][6 - i]);
    //}
    //printf("\n");
    //printf("X[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->X[1][6 - i]);
    //}
    //printf("\n");
    //printf("Y[0]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->Y[0][6 - i]);
    //}
    //printf("\n");
    //printf("Y[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->Y[1][6 - i]);
    //}
    //printf("\n");
    //printf("Z[0]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->Z[0][6 - i]);
    //}
    //printf("\n");
    //printf("Z[1]\n0x");
    //for (int i = 0; i < 7; i++)
    //{
    //    printf("%016llx", Rs[1]->Z[1][6 - i]);
    //}
    //printf("\n");
    Tate3_pairings(Rs, f);
    Dlogs3_dual(f, D, d0, c0, d1, c1);
